            ...
            <div class="container-fluid">
                <div class="container">
                    ...
                    <form method="post" id="addForm">
                        ...
                        <button class="btn btn-primary" formaction="/admin/chat_vai/add" type="submit" onclick="addProduct()">Thêm Mới</button>
                        <button class="btn btn-primary" formaction="/admin/chat_vai/update" type="submit" onclick="addProduct()">Cập nhật
                        </button>
                        <button class="btn btn-primary" formaction="/admin/chat_vai/clear" type="submit">Clear</button>
                    </form>
                </div>
            </div>
        </div>
