            ...
            <div class="container-fluid">
                <div class="container">
                    ...
                    <form method="post" id="addForm">
                        ...
                        <button class="btn btn-primary" formaction="/admin/hang/add" type="submit" onclick="addProduct()">Thêm Mới</button>
                        <button class="btn btn-primary" formaction="/admin/hang/update" type="submit" onclick="addProduct()">Cập nhật
                        </button>
                        <button class="btn btn-primary" formaction="/admin/hang/clear" type="submit">Clear</button>
                    </form>
                </div>
            </div>
        </div>
